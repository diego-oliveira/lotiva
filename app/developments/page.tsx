                ...
                <article key={development.id} className='rounded-2xl border border-border bg-surface p-5 shadow-sm'>
                  ...
                  <div className='mt-5 flex flex-col gap-3 border-t border-border pt-5 sm:flex-row sm:items-center sm:justify-between'>
                    <div className='flex flex-wrap gap-2'>
                      ...
                      <button onClick={() => { setEditingDevelopment(development); setEditingSection('basic'); setShowForm(true) }} className='rounded-xl border border-border bg-surface px-3 py-2 text-sm font-semibold text-foreground transition hover:bg-surface-secondary'>Configurar</button>
                    </div>
                    <button
                      type='button'
